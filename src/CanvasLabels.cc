...
void CanvasLabel(double x,double y,const char* text,Color_t color, double p_size_modifier) 
{
...
void CanvasLabelOld(double x,double y,bool Preliminary,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void CanvasVersion(const char* version,double x,double y,Color_t color) 
{
